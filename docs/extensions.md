...
| <a id="elide.install-version"></a>version |  Elide release version tag, e.g. `1.2.0+20260602`. Must match an entry in elide/private/versions.bzl. Defaults to the most-recently verified release.   | String | optional |  `"1.3.2+20260615"`  |
